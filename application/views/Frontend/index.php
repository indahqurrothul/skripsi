...
<body>
            ...
            <div class="row justify-content-center fs-6">
                ...
                <div class="col-md-6 mt-4">
                    ...
                    <p p align="justify">Tips agar anak tidak mengalami penyimpangan pada perkembangannya.
                        Stimulasi dini secara rutin di setiap kesempatan perlu diberikan ke anak. Sebab,
                        penyimpangan
                        tumbuh kembang anak, bahkan gangguan menetap, bisa terjadi karena kekurangan stimulasi</p>
    ...
    <div class="container">
        <div class="row text-center">
            ...
            <div class="col-md-6">
                <h4 style="margin-top: 280px;">Penyimpangan Perkembangan pada Anak</h4>
                <p>

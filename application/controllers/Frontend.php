...
//form isi data bayi
   ...
   public function konsultasi2 () {
    ...
    public function nilai_perhitungan_cf(){
        ...
        $result_data = $this->M_data_kuesioner->pengolahan_data($id_user, $id_user);

        $result_data['stimulasi_gerakkasar'] = $this->M_data_kuesioner->get_data_stimulasi_gerakkasar($id_usia);
        $result_data['stimulasi_gerakhalus'] = $this->M_data_kuesioner->get_data_stimulasi_gerakhalus($id_usia);
        $result_data['stimulasi_bicara_bahasa'] = $this->M_data_kuesioner->get_data_stimulasi_bicara_bahasa($id_usia);
        $result_data['stimulasi_sosialisasi_kemandirian'] = $this->M_data_kuesioner->get_data_stimulasi_sosialisasi_kemandirian($id_usia);


        // var_dump($result_data);
        // die();

        $this->load->view('Frontend/form_hasilperkembangan', $result_data);
